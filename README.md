...
* `star_clip_outline` - Boolean (0 or 1) indicating whether we clip a thin line around the edges of stars. This makes star clusters like M45 stand out better. Default: 1.
